...
uplink-security-WeaponLightMachineGunL2RPK-name = L2RPK
uplink-security-WeaponLightMachineGunL2RPK-desc = The RPK-L2 is a heavy machine gun from the TechnicLogistic family, designed based on the well-known L6. This machine gun stands out for its increased accuracy and low production cost. However, its design features have made it very bulky..
uplink-security-WeaponSubMachineGunScorpion-name = Scorpion
uplink-security-WeaponSubMachineGunScorpion-desc = The compact submachine gun was developed by TechnicLogistic for self-defense forces. Based on a short-barreled SMG, it is supplied to DSBF forces under order from Nanotrasen.
uplink-security-WeaponRifleScar12-name = Scar12
uplink-security-WeaponRifleScar12-desc = The Scar-12 battle rifle, developed by TechnicLogistic for its own army, is one of the most commonly found models on the black market due to its efficiency and accuracy. Currently, it is supplied to DSBF forces under a special order from NT.
